    ...
    return (
        <div className="hero min-h-screen bg-base-100 my-5 shadow-lg">
            <div className="hero-content flex-col lg:flex-row">
                <img src="https://images.unsplash.com/photo-1531545514256-b1400bc00f31?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="max-w-sm rounded-lg shadow-2xl" />
                {/* <Lottie animationData={AboutUsAnimation}></Lottie> */}
                <div>
                    <h1 className="text-5xl font-bold">About Snap Art Studio</h1>
